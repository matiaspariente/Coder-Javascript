class Carrito { 
    ...
    agregarProducto(){
        ...
        const busqueda = bebidas.find(bebidas=>bebidas.producto ==this.bebida)
        if(!objetoRepetido){ // como la bebida ya estaba en el carrito no hago un push.
            ...
            item.push(busqueda.precio)
            this.carrito.push(item) // agrego item al carrito  
            }   
        this.total += busqueda.precio
    ...
    cerrarCompra(){
        ...
        let pagoMercado = `(*) Pago en Efectivo 20% de descuento`
        document.getElementById("pagoMercado").innerHTML = pagoMercado
        let pagoTarjeta = `(*) Pago en Efectivo 20% de descuento`
